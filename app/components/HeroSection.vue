        ...
        <div class="lg:px-12 md:py-36 pb-6 pt-72 px-6 relative rounded-3xl">
          ...
          >
            <div class="px-4 w-full md:w-8/12 xl:w-6/12">
              <h4
                class="font-bold font-serif mb-1 text-secondary-600 dark:text-primary-200 uppercase"
              >
              Welcome to Mariner High School Basketball
              </h4>
              ...
              >
                <div class="inline-block ml-1 p-1.5 text-lg">Roster</div>
